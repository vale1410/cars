...
Sequence (poly propagator in \cite{Hoeve06}) constraint but is more suited for some benchmark problems and
has a linear filtering algorithm. Here we6will show that there is a
...
\begin{theorem}
    ...
    are logically equivalent to the AtMostSeqCard. Moreover they enforce
    GAC with failed literal. 
\end{theorem}
